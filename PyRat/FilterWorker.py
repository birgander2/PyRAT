    ...
    def run(self, *args, **kwargs):
        ...
        if self.checkinput():
            ...
            if "name" in self.__dict__:
                PyRat.Data.setAnnotation({"Created by":self.name},layer=self.ol)
            else:
                # PyRat.Data.setAnnotation({"Created by":type(self)},layer=self.ol)
                PyRat.Data.setAnnotation({"Created by":type(self).__name__},layer=self.ol)
            self.post()
            return self.ol
        else:
            return False
